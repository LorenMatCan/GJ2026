...
public class PlayerController : MonoBehaviour
{
    ...
    public Text MensajeLuz, MensajeInvisible;
    public float tempVelocidad, tempPoderSalto;  
    ...
    void Update()
    {
        ...
        if(Input.GetButtonDown("Jump") )
        {
            ...
            if(EstaEnElSuelo()||dobleSalto||(contadorTiempoCoyote>0f&&contadorBufferSalto>0f)){
